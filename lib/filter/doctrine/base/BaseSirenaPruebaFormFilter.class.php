...
/**
 * SirenaPrueba filter form base class.
 *
 ...
 */
abstract class BaseSirenaPruebaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sirena_prueba_filters[%s]');
  ...
  public function addJobeetAffiliatesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.SirenaPruebaAffiliate SirenaPruebaAffiliate')
      ->andWhereIn('SirenaPruebaAffiliate.affiliate_id', $values)
    ;
  }
